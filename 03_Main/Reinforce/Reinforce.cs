...
public class Additional : Reinforce
{
    public override void Execute(Weapon weapon)
    {
        AdditionalData data = Manager.BackEndChartManager.Instance.additionalData;
...
public class NormalReinforce : Reinforce
{
    public override void Execute(Weapon weapon)
    {
        BackEndChartManager resourceManager = BackEndChartManager.Instance;
...
public class Refinement : Reinforce
{
    ...
    public override void Execute(Weapon weapon)
    {
        ...
        RefinementData data = BackEndChartManager.Instance.refinementData;
        // 스탯 결정
