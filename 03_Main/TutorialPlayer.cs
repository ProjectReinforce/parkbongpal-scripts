...
public class TutorialPlayer : MonoBehaviour
{
    ...
    [SerializeField] Image directionUI;
    ...
    void Start()
    {
        ...
        if (!clearedtutorial && (Managers.ServerData.questRecordDatas[0].idList[0] == 0 || Managers.Game.Player.Record.Tutorial == 0))
        {
            ...
            panelTrans[35] = Utills.Bind<Transform>("Button_Check_S", packageUI.transform);
            panelTrans[36] = Utills.Bind<Transform>("Button_Post_S", packageUI.transform);
            panelTrans[37] = Utills.Bind<Transform>("Button_Setting", packageUI.transform);
    ...
    void TutorialIndexChecking()
    {
        ...
        if(indexCheck >= 2)
        {
            cheifControl.gameObject.transform.localScale = new Vector2(64, 64);
            cheifControl.gameObject.transform.localPosition += new Vector3(60, -55);
        }
        switch(indexCheck)
        {
            case 2:
    ...
    {
        directionUI.rectTransform.anchoredPosition += new Vector2(1.5f, -1.5f);
        directionUI.rectTransform.Rotate(0, 0, 270);
    }

    void DirectionUIChangeRectLeft()
    {
        directionUI.rectTransform.anchoredPosition += new Vector2(-1.5f, -1.5f);
        directionUI.rectTransform.Rotate(0, 0, 90);
    }

    void DirectionUIUndoRect()
    {
        directionUI.rectTransform.anchoredPosition += new Vector2(-1.5f, 1.5f);
        directionUI.rectTransform.Rotate(0, 0, 90);
    }

    void DirectionUIUndoRectLeft()
    {
        directionUI.rectTransform.anchoredPosition += new Vector2(1.5f, 1.5f);
        directionUI.rectTransform.Rotate(0, 0, 270);
    }
    ...
    void ButtonIndexChange()
    {
        ...
        switch (index)
        {
            ...
            case 27:
                ...
                DirectionUIChangeRectLeft();
                break;
            case 28:
                InventoryDecompositionOpenPopup();
                DirectionUIUndoRectLeft();
                break;
            case 29:
    ...
    void MineOpenTutorial()
    {
        ...
        if (remainTime > 0)
        {
            ...
            cheifTalk.text = "잠시만 기다려주겠나 아직 건설되지 않았다네";
            tutorialPanel.transform.parent.gameObject.SetActive(true);
    ...
    void ReinforecLendAfter()
    {
        ...
        Managers.UI.ClosePopup();
        cheifControl.transform.localPosition = new Vector3(-220, -215, 0);
    }
    ...
    void InventoryDecompositionTutorial()
    {
        textNextButton.gameObject.SetActive(true);
        tutorialPanel.transform.parent.gameObject.SetActive(false);
        cheifControl.transform.localPosition = new Vector3(-220, -160, 0);
    ...
    void PackageButtonOn()
    {
        textNextButton.gameObject.SetActive(true);
        tutorialPanel.transform.parent.gameObject.SetActive(false);
        Managers.UI.OpenPopup(packageUI.gameObject);
    }
